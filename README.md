...
Link al proyecto: [Carrito de compras REACT](https://car-compra-react.netlify.app/)

Se crea un carrito de compras en React utilizando las siguientes tecnologías y estructuras:
